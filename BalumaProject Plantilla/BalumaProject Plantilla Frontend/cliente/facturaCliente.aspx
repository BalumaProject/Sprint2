    ...
    <div class="factura">
        ...
        <%} %>
           ...
           <div class="registration_form">
                ...
                <div>
                    <asp:Button ID="Descargar" OnClick = "generar_factura" text="Descargar"  runat = "server" />
                    <asp:Button ID="Continuar" text="Continuar compra" OnClick = "continuar" runat = "server" />
				</div>
           </div>
    </div>
    <div class="clear"></div>
